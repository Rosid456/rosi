...
\__|  \__| \______/ \_______/ \__| \_______|
           ...
           \033[1;33m 
             \033[1;96m▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇
             \033[1;93m▇▇➣    \033[1;91mAUTHOR   : Abdul Rosid        \033[1;93m▇▇
             \033[1;93m▇▇➣    \033[1;94mGITHUB   : Abdul Rosid        \033[1;93m▇▇
             \033[1;93m▇▇➣    \033[1;93mFACEBOOK : Abdul Rosid        \033[1;93m▇▇
             \033[1;93m▇▇➣    \033[1;92mWHATSAPP : +8801936706784     \033[1;93m▇▇
...
def reg():
    os.system('termux-setup-storage')
    os.system('clear')
    os.system('xdg-open https://www.facebook.com/mdrosid.alli')
    logo()
    print ('')
...
def reg2():
    ...
    os.system('am start https://wa.me/+8801736706784?text=' + tks)
...
def chigozie():
    ...
    if cookie in['OPEN','Open','open']:
      jalan("\n  %s* %sanda akan di arahkan ke YouTube"%(O,O));time.sleep(3);os.system('xdg-open https://wa.me/+8801936706784');chigozie()
    try:
...
def bsn_menu():
    ...
    IP = ipm["origin"]
    print("             [*]. CREATED BY : Abdul Rosid ");time.sleep (0.03)
    print("             [*]. FACEBOOK   : Abdul Rosid");time.sleep (0.03)
    print("             [*]. GITHUB     : Abdul Rosid");time.sleep (0.03)   
